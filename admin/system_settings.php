...
//require_once(__DIR__.'/includes/EditProfile.php');
if ($login_u['role']==1) {
require_once(__DIR__.'/includes/UpdateSystemSettings.php');
...
<head>
    ...
    <title><?php echo $setting['system_name'];?> - Settings</title>
    <!-- Bootstrap CSS -->
       ...
       <div class="nav-left-sidebar sidebar-dark">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <?php include(__DIR__.'/includes/SystemSettingsForms.php');?>
                </div>
...
<?php } else { header('Location: dashboard.php'); }  mysqli_close($connection); ?>