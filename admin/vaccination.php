...
require_once(__DIR__.'/includes/AddNewVaccination.php');
...
<head>
    ...
    <title><?php echo $setting['system_name'];?> - Vaccination</title>
    <!-- Bootstrap CSS -->
       ...
       <div class="nav-left-sidebar sidebar-dark">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <?php include(__DIR__.'/includes/NewVaccinationForm.php');?>
                </div>
