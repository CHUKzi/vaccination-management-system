...
<html lang="en">
  <head>
    ...
    <title><?php echo $setting['system_name'];?> - News Page</title>
...
<div class="jumbotron text-center bg-image" style="margin-bottom:0; background-image: url('images/bg/pages-bg.jpg');">
  ...
  <p class="text-white"><a href="#" class="text-white">Home Page</a> / <a href="#" class="text-white">News</a></p> 
</div>

<main role="main">
  <br>
  <div class="container marketing">
    <?php include(__DIR__.'/includes/NewsCards.php');?>
  </div>
